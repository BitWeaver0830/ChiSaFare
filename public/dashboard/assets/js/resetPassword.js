...
function getSecurityQuestion(){
    ...
    $.ajax({
        url: "/api/businessConsultant/getSecurityQuestion",
        type: "POST",
...
function resetPassword(email){
    ...
    $.ajax({
        url: "/api/businessConsultant/resetPassword",
        type: "POST",
        data: JSON.stringify({email, securityAnswer: $('#securityAnswer').val(), securityQuestion: $('#securityQuestion').text()}),
        contentType: "application/json",
    }).done((response) => {
